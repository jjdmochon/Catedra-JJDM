---
title: "Courses and Teaching Overview: Prof. Juan José Díaz-Mochón"
type: course
date_created: 2026-08-26
date_updated: 2026-08-26
status: active
confidence: high
tags: [teaching, pedagogy, UGR, pharmacy, master, transmed]
...
```mermaid
graph TD
    A["Prof. Juan José Díaz-Mochón Teaching Portfolio"] --> B["Grado en Farmacia (Core Undergraduate)"]
    A --> C["Máster Oficial TRANSMED (Postgraduate)"]
    
    B --> D["Química Farmacéutica I (QFUNO)"]
    B --> E["Química Farmacéutica II (QFDOS)"]
    B --> F["Química Orgánica (QO)"]
    
    C --> G["Translational Medicine & Diagnostics"]
```
